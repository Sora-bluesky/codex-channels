...
Assert-FileContains -Path 'README.md' -Needle 'ask for the task in normal chat'
...
Assert-FileContains -Path 'README.ja.md' -Needle '通常のチャットとして'
...
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle 'use a normal chat request'
...
Assert-FileContains -Path 'docs/telegram-quickstart.md' -Needle 'You do not need an `@remotty` mention'
...
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle '通常のチャット文'
...
Assert-FileContains -Path 'docs/telegram-quickstart.ja.md' -Needle '`@remotty` の表示は必須ではありません'
